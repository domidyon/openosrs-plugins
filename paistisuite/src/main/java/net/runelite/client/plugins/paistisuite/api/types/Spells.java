...
public enum Spells {
    ...
    ARCEUUS_HOME_TELEPORT("Arceuus Home Teleport", WidgetInfo.SPELL_ARCEUUS_HOME_TELEPORT),
    EDGEVILLE_HOME_TELEPORT("Edgeville Home Teleport", WidgetInfo.SPELL_EDGEVILLE_HOME_TELEPORT),
    LUMBRIDGE_HOME_TELEPORT("Lumbridge Home Teleport", WidgetInfo.SPELL_LUMBRIDGE_HOME_TELEPORT),
    LUNAR_HOME_TELEPORT("Lunar Home Teleport", WidgetInfo.SPELL_LUNAR_HOME_TELEPORT),
